...
require.register("mongoose-knockout/adapter/socket.js", function(exports, require, module){
...
require.register("mongoose-knockout/adapter/rest.js", function(exports, require, module){
// Generated by CoffeeScript 1.8.0
...
require.register("mongoose-knockout/adapter/index.js", function(exports, require, module){
// Generated by CoffeeScript 1.8.0
...
Cursor = (function() {
  function Cursor(model, func_name, query, cb) {
    ...
    this.status = oo('none');
    this.cb = cb;
    this.has_previous = co((function(_this) {
      return function() {
        if (_this.page() > 0) {
          return true;
        }
    ...
    this.has_next = co((function(_this) {
      return function() {
...
Model = (function() {
  ...
  function Model(options) {
    ...
    this.network_status = co((function(_this) {
      return function() {
    ...
    for (key in this.model) {
      ...
      if (atrs.validate) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          valid = _ref[_i];
          data = false;
          valid.validator(doc[key], (function(_this) {
            return function(d) {
              return data = d;
            };
          })(this));
  ...
  Model.prototype.create = function(query, temp_options, cb) {
    ...
    this.network_count(this.network_count() + 1);
    this.adapter.create(query, (function(_this) {
  ...
  Model.prototype.update = function(query, temp_options, cb) {
    ...
    this.network_count(this.network_count() + 1);
    return this.adapter.update(query, (function(_this) {
      return function(err) {
        if (cb) {
          cb(err);
        }
  ...
  Model.prototype.remove = function(query, temp_options, cb) {
    this.network_count(this.network_count() + 1);
    return this.adapter.remove(query, (function(_this) {
      return function(err) {
        if (cb) {
          cb(err);
        }
  ...
  Model.prototype.findOne = function(query, temp_options, cb, cursor) {
    ...
    this.network_count(this.network_count() + 1);
    this.adapter.findOne(query, (function(_this) {
  ...
  Model.prototype.find = function(query, temp_options, cb, cursor) {
    ...
    cursor.status('loading');
    this.network_count(this.network_count() + 1);
    this.adapter.find(query, (function(_this) {
      return function(err, docs, options) {
  ...
  Model.prototype.count = function(query, temp_options, cb, cursor) {
    ...
    cursor.status('loading');
    this.network_count(this.network_count() + 1);
    this.adapter.count(query, (function(_this) {
  ...
  Model.prototype.aggregate = function(query, temp_options, cb, cursor) {
    ...
    cursor.status('loading');
    this.network_count(this.network_count() + 1);
    this.adapter.aggregate(query, (function(_this) {
...
require.alias("forbeslindesay-ajax/index.js", "mongoose-knockout/deps/ajax/index.js");
...
require.alias("component-json/index.js", "mongoose-knockout/deps/json/index.js");
require.alias("component-json/index.js", "json/index.js");

require.alias("lodash-lodash/index.js", "mongoose-knockout/deps/lodash/index.js");
require.alias("lodash-lodash/dist/lodash.compat.js", "mongoose-knockout/deps/lodash/dist/lodash.compat.js");
require.alias("lodash-lodash/index.js", "lodash/index.js");

require.alias("component-emitter/index.js", "mongoose-knockout/deps/emitter/index.js");
require.alias("component-emitter/index.js", "emitter/index.js");

require.alias("mongoose-knockout/index.js", "mongoose-knockout/index.js");if (typeof exports == "object") {
  module.exports = require("mongoose-knockout");
} else if (typeof define == "function" && define.amd) {
  define([], function(){ return require("mongoose-knockout"); });
} else {
  this["mk"] = require("mongoose-knockout");
}})();